export const EXHIBIT_LIST = [
  ...
  {
    label: "Going Viral Travelling Exhibition",
  ...
  {
    label: "Phobia²: The Science of Fear",
  ...
  {
    label: "Professor Crackitt's Light Fantastic Mirror Maze",
    title: "Professor Crackitt's Light Fantastic Mirror Maze",
    shortDescription:
      "Mirror maze of reflections, illusions and light tricks that challenges your sense of direction and perception.",
  },
  {
    label: "Savage Garden",
    title: "Savage Garden",
